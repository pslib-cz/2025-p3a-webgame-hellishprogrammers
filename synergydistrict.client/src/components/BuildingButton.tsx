...
export const BuildingButton:FC<BuildingButtonProps> = (props:BuildingButtonProps) => {
    ...
    return(
        ...
        <IconButton OnClick={() => handleOnClick(props.buildingIconName)} isSelected={active == props.buildingIconName } iconKey={props.buildingIconName} amount={props.amount}></IconButton>
